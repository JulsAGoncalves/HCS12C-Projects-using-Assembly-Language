*****************************************************************
* String Display and ASCII Character Displayer                  *
* Uses an inputted String and 2 digit hex number and            *
* displays data on the LCD Screen using subroutines for         *
* screen operations                                             *
