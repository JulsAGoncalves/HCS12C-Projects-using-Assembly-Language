;*****************************************************************
;* A program that uses interrupt timers to display A B and C     *
;* at different times on the display                             *
...
A1          LDAA  #'B'                      ; Display B (for 2 sec)
            ...
            ADDA  #TwoSec  ;HERE HERE HERE                 ; by adding on the 2 sec delay
            STAA  AT_DEMO       ;THIS           ; and save it in the alarm
CHK_DELAY_2 LDAA  TOF_COUNTER               ; If the current time
            CMPA  AT_DEMO     ;THIS              ; equals the alarm time
...
;subroutine section    ;ALL FROM PREVIOUS LAB
;*******************************************************************
