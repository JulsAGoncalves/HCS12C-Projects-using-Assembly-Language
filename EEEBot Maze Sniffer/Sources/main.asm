; *****************************************************************
; * BEHOLD! OUR MASTERPIECE! THE GATHERING OF ALL THAT HAS BEEN   *
; * LEARNED THUS FAR! OUR MICROPROCESSING MAGNUM OPUS!!!          *
; * ;) I only used 20% of my true potential (We barely            *
; * finished it) This project uses the eebot to follow a simple   *
; * maze, understanding when it reaches a dead end, and knowing to*
; * not go down a path that has already been treaded. But the     *
; * hard part of this whole shabang was to make sure that this    *
; * damned robot stays on its path the entire time. Making sure to*
; * use our sensors to their MAXIMUM POTENTIAL I think... This    *
; * robot was made for the sole purpose of this project afterall  *
; * Author's: Julian Goncalves, Malcom (The Man), Eddy Perez      *
; *****************************************************************
